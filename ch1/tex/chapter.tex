...
Besides talking about the existence of the speed of sound, there's
...
Why? For all its vagueness equation~(\ref{ch1:eqvsgen}) buys us power
...
\section[When dispersion relations become dispersive]{When dispersion
  relations become dispersive,\protect{\footnote{*gasp!*}} or, ``How
...
Equation (\ref{ch1:eqAlf}) says that the same goes for waves in an MHD
...
relation]{A ``big wheel''\protect{\footnote{Remember that trike with
      ...
      three?}} derivation of the dispersion relation for inertial \Alf
  waves}
...
\begin{figure}
  \centering
  \noindent\includegraphics[width=0.8\textwidth]{./ch1/figs/dombeck2013}
