...
\subsubsection{Preliminary \#2: Meet the (linearized) equations}
...
pass peer review], or for neither. The last possibility is far and away most
probable, since for the main, science only proceeds haltingly and in fits and
spurts.\footnote{I am hosing around with the whole ``total glory'' thing. Did
  you see the very first footnote in this chapter? Though I here mock that
  sentiment, to truth, and to truth only, be total glory.}
