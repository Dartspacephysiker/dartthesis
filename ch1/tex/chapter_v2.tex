...
\begin{equation*} 
  ...
  \end{alignedat}
\end{equation*}
Now we do the famous ``drop all terms of order [uninteresting science],'' in this case $m_e/m_i$, so that
...
us? I've always hated camping and I wish I were home.'' But (in the words of
Robert Frost) we're out for stars! First we enter a veritable thicket of math,
in which you are almost definitely going to lose your sense of direction if
you've never before traversed such terrain. If I plug the expressions
(\ref{ch1:eqDaddy}) for $j_x$ and $j_z$ into (\ref{ch1:eqCont2}), I obtain the
seemingly meaningless result
\begin{equation*}
  % \begin{alignedat}{4}
...
Take heart, tenderfoot. pwe're near the top.
