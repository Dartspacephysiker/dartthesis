...
to tease this out, and one of the results seems to confirm an effect observed in
simulation that is counterintuitive based on what other studies have
established. In specific, a simulation-based study of IMF control of
\emph{nondispersive, large-scale} \Alf waves (as opposed to \emph{small-scale,
  dispersive} \Alf waves).
