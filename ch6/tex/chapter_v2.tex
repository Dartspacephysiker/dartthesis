...
% \begin{abstract}
%   We report in situ measurements through the auroral acceleration region that
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  Under a Lagrangian interpretation of temperature, for all other parameters
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  Figure~\ref{ch6:Fig1}c shows the best-fit kappa parameters resulting from 2-D
  ...
  % the linearity condition $\Delta \Phi / T \ll R_B $. First, relative to the
  ...
  % highly nonthermal population is compatible with a high-altitude scenario and
  % marginally compatible with a low-altitude scenario, but a source in or near
  % thermal equilibrium is only compatible with a low-altitude
  % scenario. 
...
%   Figure~\ref{ch6:Fig1}a
  ...
  Figure~\ref{ch6:Fig5} is in the same format as Figure~\ref{ch6:Fig2}. The top
