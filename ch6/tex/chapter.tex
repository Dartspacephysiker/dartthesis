...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{figure}
    ...
    \noindent\includegraphics[width=0.98\textwidth]{./ch6/figs/Kappa_summary--1773__v2__itvl3integ}
    \caption[Inverted V precipitation and best-fit Maxwellian and kappa
  ...
  \begin{figure}
    ...
    \noindent\includegraphics[width=0.9\textwidth]{./ch6/figs/orb_1773--1DFit_3avgItvl__v1_20170613}

    \vspace{1cm}

    % \noindent\includegraphics[width=0.8\textwidth,angle=90]{./ch6/figs/orb_1773-Kappa_fit-09_27_01__57}
    \noindent\includegraphics[width=0.9\textwidth,angle=90]{./ch6/figs/orb_1773-Kappa_fit-09_27_04__26}
  ...
  \begin{figure}
    ...
    \noindent\includegraphics[width=0.91\textwidth]{./ch6/figs/orb_1773_lump1_kappa_RB_map__v1_20170605--trim}
    \noindent\includegraphics[width=0.91\textwidth]{./ch6/figs/orb_1773_lump1_kappa_RB_map__superbestfit__v1_20170605--trim}
  ...
  to a source at $h \simeq$~8.5~$R_E$. However, it is apparent that a source
  region down to $h \simeq$~4.7~$R_E$ is similarly plausible for
  ...
  and is given by $R_B =$~8.55, corresponding to a source altitude
  $h \simeq$~2~$R_E$.
  ...
  ($h \lesssim$~2~$R_E$) or high ($h \gtrsim$~4.7~$R_E$) source region altitudes, but a
  ...
  nearby ($h <$~2.2~$R_E$) source in thermal equilbrium.
  ...
  interest in Figure~\ref{ch6:Fig1}, with $E_p \simeq 850$~V and $T =$~600~eV,
...
%   Figure~\ref{ch6:Fig1}a
  ...
  \begin{figure}
    ...
    \noindent\includegraphics[width=0.9\textwidth]{./ch6/figs/Kappa_summary--1843__v2__itvl3integ}
    \caption[Inverted V precipitation and best-fit Maxwellian and kappa
  ...
  \begin{figure}
    \centering \contcaption{Electron spectra observed at 20:50:09.18~UT. (a) 1-D
      differential number flux spectrum (black crosses) obtained by averaging
      all differential number flux spectra within the magnetospheric source
      cone, with best-fit Maxwellian and kappa distributions overlaid (red
      dash-dotted line and blue dashed line, respectively). The uncertainty of
  ...
  mirror ratio $R_{B,T} = 22$ (or a source altitude $h \simeq$~2.5~$R_E$) is
  ...
  \begin{figure}
    ...
    \noindent\includegraphics[width=0.9\textwidth]{./ch6/figs/orb_1843__kappa_RB_map__20170605__v2--trim}
    \noindent\includegraphics[width=0.9\textwidth]{./ch6/figs/orb_1843__map_linear__bestfit__20170605__v2--trim}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{figure}
    \centering
    \noindent\includegraphics[width=0.9\textwidth]{./ch6/figs/orb_1773__local_analysis--trim}
    \noindent\includegraphics[width=0.9\textwidth]{./ch6/figs/orb_1773__local_analysis--T_and_N--trim}
    ...
    curves and corresponding best-fit curves.]{Results of ``local'' J-V curve
      ...
      J-V relationship between 09:26:54 and 09:27:05~UT in
  ...
  11-s period between red bars in Figure~\ref{ch6:Fig1}. It is immediately obvious que los hermanos
  ...
  \begin{figure}
    \centering
    \noindent\includegraphics[width=0.9\textwidth]{./ch6/figs/orb_1843__local_analysis--trim}
    \noindent\includegraphics[width=0.9\textwidth]{./ch6/figs/orb_1843__local_analysis--T_and_N--trim}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  precipitating electron distributions during the 11-s period marked in
