...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  Both nonthermal and thermal sources are represented in Figure~\ref{ch6:Fig3}b,
  ...
  Figure~\ref{ch6:Fig3}a shows that a source region above 2~$R_E$ is implausible
